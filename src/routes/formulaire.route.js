...
class FormulaireRoutes extends BaseRoute {
    constructor() {
        ...
        this.formulaireController = new FormulaireController();
...
module.exports = FormulaireRoutes;